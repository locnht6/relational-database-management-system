...
-- chữ, câu/đoạn văn,
-- ngày tháng, tiền ($...)
-- 1 ngôn ngữ lập trình sẽ hỗ trợ nhiều loại dữ liệu khác nhau - data type

-- Khi lập trình trong SQL Server, vì câu lệnh sẽ nằm trên nhiều dòng,
-- mình cần nhắc Tool này 1 câu: đừng nhìn lệnh riêng lẻ (nhiều dòng) mà hãy nhìn nguyên cụm lệnh mới có ý nghĩa (BATCH),
