...
INSERT INTO PhoneBookV1 VALUES (N'locnht', '090x')
-- Bạn An có 2 số phone, làm sao để lưu?
INSERT INTO PhoneBookV1 VALUES (N'annguyen', '090x, 091x')

-- Bình có 3 số phone, làm sao lưu? Mày khong thấy tao để độ rộng của phone là 50 à.
...
-- >>>>> Đáp án: quy ước số đầu tiên là để bàn, số 2 là di động, số 3 là work.
-- >>>>> Rất rắc rối vì quy ước ngầm, số nào là loại nào!!! khó nhớ cho người nhập liệu.
...
-- KHÓ KHĂN XẢY RA KHI TA GOM NHIỀU VALUE CÙNG KIỂU, NGỮ NGHĨA VÀO TRONG 1 COLUMN (cột Phone lưu nhiều số phone cách nhau dấu cách),
-- gây khó khăn cho nhập dữ liệu (không nhất quán dấu cách), khi SELECT COUNT() thống kê theo tiêu chí (in số phone ở nhà),
-- update thêm phone mới, xóa số cũ.

-- MỘT CELL MÀ CHỨA NHIỀU VALUE CÙNG KIỂU ĐƯỢC GỌI LÀ CỘT ĐA TRỊ - MULTI-VALUED COLUMN -> TIỀM ẨN NHIỀU KHÓ KHĂN CHO VIỆC XỬ LÍ DATA.

-- NẾU 1 TABLE CÓ CỘT ĐA TRỊ NGƯỜI TA NÓI RẰNG NÓ KHÔNG ĐẠT CHUẨN 1,
